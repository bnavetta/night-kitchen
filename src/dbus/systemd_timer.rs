...
// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.systemd1 -p /org/freedesktop/systemd1/unit/shadow_2etimer -f org.freedesktop.systemd1.Timer -c blocking -m None -o src/dbus/systemd_timer.rs`, see https://github.com/diwic/dbus-rs
use dbus;
use dbus::arg;
use dbus::blocking;
...
impl<'a, C: ::std::ops::Deref<Target = blocking::Connection>> OrgFreedesktopSystemd1Timer
