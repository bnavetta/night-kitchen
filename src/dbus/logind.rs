// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.login1 -p /org/freedesktop/login1 -f org.freedesktop.login1.Manager,org.freedesktop.login1.Session -c blocking -m None -o src/bindings.rs`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
use dbus::arg;
use dbus::blocking;
...
impl<'a, C: ::std::ops::Deref<Target=blocking::Connection>> OrgFreedesktopLogin1Manager for blocking::Proxy<'a, C> {
    ...
    fn set_wall_message_(&self, arg0: &str, arg1: bool) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.login1.Manager", "SetWallMessage", (arg0, arg1, ))
    }
