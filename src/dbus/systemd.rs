// This code was autogenerated with `dbus-codegen-rust -s -d org.freedesktop.systemd1 -p /org/freedesktop/systemd1 -f org.freedesktop.systemd1.Manager -c blocking -m None -o src/dbus/systemd.rs`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
use dbus::arg;
use dbus::blocking;
...
pub trait OrgFreedesktopSystemd1Manager {
    ...
    fn enqueue_unit_job(&self, arg0: &str, arg1: &str, arg2: &str) -> Result<(u32, dbus::Path<'static>, String, dbus::Path<'static>, String, Vec<(u32, dbus::Path<'static>, String, dbus::Path<'static>, String)>), dbus::Error>;
    fn kill_unit(&self, arg0: &str, arg1: &str, arg2: i32) -> Result<(), dbus::Error>;
    fn clean_unit(&self, arg0: &str, arg1: Vec<&str>) -> Result<(), dbus::Error>;
...
impl<'a, C: ::std::ops::Deref<Target=blocking::Connection>> OrgFreedesktopSystemd1Manager for blocking::Proxy<'a, C> {
    ...
    fn enqueue_unit_job(&self, arg0: &str, arg1: &str, arg2: &str) -> Result<(u32, dbus::Path<'static>, String, dbus::Path<'static>, String, Vec<(u32, dbus::Path<'static>, String, dbus::Path<'static>, String)>), dbus::Error> {
        self.method_call("org.freedesktop.systemd1.Manager", "EnqueueUnitJob", (arg0, arg1, arg2, ))
    }
    ...
    fn clean_unit(&self, arg0: &str, arg1: Vec<&str>) -> Result<(), dbus::Error> {
        self.method_call("org.freedesktop.systemd1.Manager", "CleanUnit", (arg0, arg1, ))
    }
